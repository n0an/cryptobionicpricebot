...
# web application at http://noant.pythonanywhere.com/
...
#import sys
#
#path = '/home/noant/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/noant/mysite/mysite/settings.py'
## and your manage.py is is at '/home/noant/mysite/manage.py'
#path = '/home/noant/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
import sys
#
## The "/home/noant" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/noant/myproject"
path = '/home/noant/bot'
if path not in sys.path:
    sys.path.append(path)
#
